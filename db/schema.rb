...
ActiveRecord::Schema[7.0].define(version: 2023_05_27_203749) do
  ...
  create_table "servicemen", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_servicemen_on_email", unique: true
    t.index ["reset_password_token"], name: "index_servicemen_on_reset_password_token", unique: true
  end
